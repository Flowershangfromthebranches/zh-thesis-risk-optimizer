...
- [ ] `examples/04-engineering-thesis-example.md`
- [ ] `examples/05-citation-heavy-example.md`
- [ ] `examples/06-long-thesis-workflow.md`
...
- [ ] DISCIPLINE_AIGC_BOTTLENECK_RULES exists.
- [ ] AIGC_FOCUSED_LENGTH_CONTROLLED exists.
- [ ] CHARACTER_DELTA_GUARD exists.
